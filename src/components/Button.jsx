...
export default function Button({ children, variant = 'primary', className = '', disabled = false, isLoading = false, ...props }) {
  ...
  const variants = {
    primary: 'border border-[var(--btn-primary-border)] bg-[var(--btn-primary-bg)] text-[var(--btn-primary-text)] shadow-[var(--btn-primary-shadow)] hover:-translate-y-0.5 hover:border-[var(--btn-primary-bg-hover)] hover:bg-[var(--btn-primary-bg-hover)] hover:shadow-[var(--btn-primary-shadow)] active:bg-[var(--btn-primary-bg-active)] focus:ring-sky-400',
    secondary: 'border border-[var(--btn-secondary-border)] bg-[var(--btn-secondary-bg)] text-[var(--btn-secondary-text)] shadow-[var(--btn-secondary-shadow)] hover:-translate-y-0.5 hover:bg-[var(--btn-secondary-hover-bg)]',
